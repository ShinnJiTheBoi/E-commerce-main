...
export class UpdateProductComponent {
  ...
  ngOnInit(): void {
    this.productForm = this.fb.group({
      ...
      updatedQuantity: [0,[Validators.required]],
    });
  ...
  updateProduct(): void {
    if (this.productForm.valid) {
      ...
      formData.append('quantity', this.productForm.get('updatedQuantity').value);
      formData.append('waitingTime', this.productForm.get('waitingTime').value);
